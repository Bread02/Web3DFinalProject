...
<body>
      ...
      <div class="col-sm-8">
        ...
        <div class="card-body" class="container-fluid main_contents">
          ...
          <div id="cup">
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div id="cupDescription">
                  <h4 class="card-title"><?php echo $data[0]["modelTitle"]; ?></h4>
            ...
            <!-- END OF FINAL ROW -->
            <div class="col-sm-6">
            <h4 class="card-title">Model Creation</h4>
              <div class="card-text drinksText"><?php echo $data[0]["x3dCreationMethod"]; ?></div>
            </div>
          </div>
          </div>
          ...
          <div class="row">
              <div class="col-sm-6">
                <div class="card-body">
                  ...
                  <h4 class="card-title"><?php echo $data[1]["modelTitle"]; ?></h4>
          ...
          <div class="row">
              <div class="col-sm-6">
                <div class="card-body">
                  ...
                  <h4 class="card-title"><?php echo $data[2]["modelTitle"]; ?></h4>
  ...
  <div id="references">
    ...
    Please also be sure to produce appropriate citations within your web pages to all sources of content, including X3D/VRML functions, extensions, HTML, JavaScrip, ... code, etc. that you have not developed yourself.  For each piece of content that is not developed by yourself you should 'cite and refer' via a hyperlink to the source (via this page) that lists your references just as if you had written an essay or report.
  </div>
  <!-- END OF REFERENCES -->
