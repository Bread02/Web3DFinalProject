        ...
        <div id="costaNews">
          <div class="card text-center">
            <div class="card-body-home-news-main">
              ...
              <div class="card-body-home-news">
                <iframe width="1920" height="1080" src="https://www.youtube.com/embed/55DmnepMuTE?si=RCTSf5hy3zSs6b7g"
        ...
        <div id="colaNews">
          <div class="card text-center">
            <div class="card-body-home-news-main">
              ...
              <div class="card-body-home-news">
                <iframe width="1920" height="1080" src="https://www.youtube.com/embed/chFGAkBRHVE?si=2X5OxFu4vyHsBpJn"
                  title="YouTube video player" frameborder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      ...
      <div class="col-sm-8">
        ...
        <div class="card-body" class="container-fluid main_contents">
          ...
          <div class="model3D">
            ...
            <div id="x3dScene">
              <x3d id="wire" width="1095px" height="725px">
                <scene>
            ...
            <div id="x3dVideoCup" style="display:none;">
              <iframe width="600" height="400" src="https://www.youtube.com/embed/chFGAkBRHVE?si=2X5OxFu4vyHsBpJn"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
